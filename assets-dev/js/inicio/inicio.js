$(function () {
    ...
    $.fn.activarPanel = function (modulo, color) {
        ...
        $('#img' + modulo).attr('src', base_url + 'assets/images/inicio/inicio_' + modulo.toLowerCase() + '2.png');
    ...
    $.fn.panelCOMPLETADO = function (modulo, color) {
        ...
        $('#img' + modulo).attr('src', base_url + 'assets/images/inicio/inicio_' + modulo.toLowerCase() + '3.png');
    };
    ...
    $.fn.activarPanelCOMPLETADO = function (modulo, color) {
        ...
        $('#img' + modulo).attr('src', base_url + 'assets/images/inicio/inicio_' + modulo.toLowerCase() + '3.png');
        $('#panel' + modulo).on('click', function() {
            if(modulo.toLowerCase() == "hogar"){
                //$(location).attr('href', base_url + modulo.toLowerCase() + "/seleccionHogar");
                $(location).attr('href', base_url + modulo.toLowerCase());
            }else{
                $(location).attr('href', base_url + modulo.toLowerCase());
            }
